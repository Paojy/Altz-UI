...
local resetposbutton = CreateFrame("Button", G.uiname.."ResetPosButton", _G[G.uiname.."Intro Frame"], "UIPanelButtonTemplate")
resetposbutton:SetPoint("TOP", _G[G.uiname.."ResetButton"], "BOTTOM", 0, -5)
resetposbutton:SetSize(250, 25)
