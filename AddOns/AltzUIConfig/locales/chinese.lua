...
L["微型菜单"] = "微型菜单"
L["微型菜单tips"] = "右键点击你的头像可以打开Altz UI的便捷菜单，点击菜单中的"..L["控制台"].."，里面还有提示哦！"
L["信息栏"] = "信息栏"
L["信息栏tips"] = "信息栏上的大部分状态数字都可以点击哦，你可以在此打开好友和公会面板。"
L["解锁按钮"] = "解锁按钮"
...
L["按职业染色提示"] = "启用: 按职业染色生命条，按能量类型染色能能条。\n禁用 : 按血量百分比染色生命条，按职业染色能量条。"
L["反向填充"] = "反向填充"
L["反向填充提示"] = "反向填充生命条"
L["渐变开始透颜色"] = "渐变开始透颜色"
L["渐变结束透颜色"] = "渐变结束透颜色"
L["名字职业着色"] = "名字职业着色"
L["名字职业着色提示"] = "启用: 职业颜色 禁用: 白色"
L["肖像"] = "肖像"
L["显示肖像"] = "显示肖像"
L["肖像透明度"] = "肖像透明度"
...
L["显示冷却时间"] = "显示冷却时间"
L["冷却时间数字大小"] = "冷却时间数字大小"
L["冷却时间数字大小提示"] = "只能调整大于20*20象素冷却框体的字号，更小的冷却框体会自动调整到适合的字号。注意如果框体太小则不会显示冷却数字。"
...
L["姓名板高度"] = "姓名板高度"
L["显示减益"] = "显示减益"
L["显示减益提示"] = "在姓名板上显示重要的减益"
L["显示增益"] = "显示增益"
L["显示增益提示"] = "在姓名板上显示重要的增益,主要用于PVP"
L["自动显示/隐藏"] = "自动显示/隐藏"
L["自动显示/隐藏提示"] = "当进入战斗时自动打开姓名板和离开战斗自动隐藏姓名板"
L["仇恨染色"] = "仇恨染色"
L["仇恨染色提示"] = "获得怪物仇恨后姓名板变色。"
...
L["过滤战斗信息"] = "启用过滤"
L["过滤战斗信息提示"] = "隐藏大部分范围伤害和治疗信息来避免刷屏。"
L["暴击图标大小"] = "暴击图标大小"
L["显示DOT"] = "显示DOT"
L["显示HOT"] = "显示HOT"
L["显示宠物"] = "显示宠物"
...
L["团队工具"] = "团队工具"
L["1-5队"] = "只对1-5队生效"
L["药水通报"] = "在战斗结束后通报喝药水情况。"
L["药水通报过滤"] = "忽略以下玩家:"
L["药水通报过滤提示"] = "输入玩家名字，用空格隔开。"
L["需要启用DBM"] = "需要启用DBM。"
L["倒数时长"] = "倒数时长"
...
L["插件皮肤"] = "皮肤"
L["更改设置"] = "更改设置"
L["更改设置提示"] = "一部分设置需要更改才能与整体风格保持一致，你可以勾选"..L["更改设置"].."在下次登陆或重载界面时实现这些修改。"
