...
L["微型菜单"] = "Micro Menu"
L["微型菜单tips"] = "Right click your potrait will toggle AltzUI menu, please click the "..L["控制台"].." in the menu list."
L["信息栏"] = "Info Frame"
L["信息栏tips"] = "Most of the stats values in Info Frame is clickable. You may toggle friends or guild frame here."
...
L["反向填充"] = "Reverse Fill"
L["反向填充提示"] = "Reverse Fill heath bar"
L["渐变开始透颜色"] = "Gradient Start Color"
L["渐变结束透颜色"] = "Gradient End Color"
...
L["自动交接任务提示"] = "Automaticly receive and turn in quests."
L["大喊被闷了"] = "Say Sapped"
