...
L["微型菜单"] = "微型菜單"
L["微型菜单tips"] = "右鍵點擊你的頭像可以打開Altz UI的快捷菜單，點擊菜單中的"..L["控制台"].."，裡面還有提示哦！"
L["信息栏"] = "信息欄"
L["信息栏tips"] = "信息欄上的大部分狀態數字都可以點擊哦，你可以在此打開好友和公會面板。"
L["解锁按钮"] = "解鎖按鈕"
...
L["按职业染色提示"] = "啟用: 按職業染色生命條，按能量類型染色能量條。\n禁用 : 按血量百分比染色生命條，按職業染色能量條。"
L["反向填充"] = "反向填充"
L["反向填充提示"] = "反向填充生命條"
L["渐变开始透颜色"] = "漸變開始透顏色"
L["渐变结束透颜色"] = "漸變結束透顏色"
L["名字职业着色"] = "名字職業著色"
L["名字职业着色提示"] = "啟用: 職業顏色 禁用: 白色"
L["肖像"] = "肖像"
L["显示肖像"] = "顯示肖像"
L["肖像透明度"] = "肖像透明度"
...
L["冷却时间数字大小"] = "冷却時間字體大小"
L["冷却时间数字大小提示"] = "只能調整大于20*20象素冷卻框體的字號，更小的冷卻框體會自動調整到適合的字號。注意如果框體太小則不會顯示冷卻數字。"
L["不可用颜色"] = "不可用顏色"
...
L["姓名板高度"] = "姓名板高度"
L["显示减益"] = "顯示減益"
L["显示减益提示"] = "在姓名板上顯示重要的減益"
L["显示增益"] = "顯示增益"
L["显示增益提示"] = "在姓名板上顯示重要的增益,主要用於PVP"
L["自动显示/隐藏"] = "自動顯示/隱藏"
L["自动显示/隐藏提示"] = "當進入戰鬥時自動打開姓名板和離開戰鬥自動隱藏姓名板"
L["仇恨染色"] = "仇恨染色"
L["仇恨染色提示"] = "獲得怪物仇恨後姓名板變色。"
...
L["过滤战斗信息"] = "啟用過濾"
L["过滤战斗信息提示"] = "隱藏大部分範圍傷害和治療信息來避免刷屏。"
L["暴击图标大小"] = "暴擊圖標大小"
L["显示DOT"] = "顯示DOT"
L["显示HOT"] = "顯示HOT"
L["显示宠物"] = "顯示寵物"
...
L["团队工具"] = "團隊工具"
L["1-5队"] = "只對1-5隊生效"
L["药水通报"] = "在戰鬥結束後通報喝藥水情况。"
L["药水通报过滤"] = "忽略以下玩家:"
L["药水通报过滤提示"] = "輸入玩家名字，用空格隔開。"
L["需要启用DBM"] = "需要啟用DBM。"
L["倒数时长"] = "倒數時長"
...
L["插件皮肤"] = "皮膚"
L["更改设置"] = "更改設置"
L["更改设置提示"] = "一部分設置需要更改才能與整體風格保持一致，你可以勾選"..L["更改设置"].."在下次登陸或重載界面時實現這些修改。"
