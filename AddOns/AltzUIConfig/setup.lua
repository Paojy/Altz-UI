...
local function CreateInstructions()
	CreateInstruction(_G[G.uiname.."Topleft Info Frame"], nil, L["信息栏"], L["信息栏tips"], "ANCHOR_RIGHT")
	CreateInstruction(Minimap, nil,L["小地图"], L["小地图tips"], "ANCHOR_LEFT")
	CreateInstruction(ChatFrame1, nil, L["聊天框"], L["聊天框tips"], "ANCHOR_TOPLEFT")
	CreateInstruction(_G[G.uiname.."MicromenuBar"], _G[G.uiname.."CharButton"], L["微型菜单"], L["微型菜单tips"], "ANCHOR_TOPLEFT")
