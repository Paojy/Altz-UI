...
L["整理背包提示"] = "BotãoEsquerdo - organizar em ordem decrescente\nBotãoDireito - organizar em ordem crescente"
...
L["插件管理"] = "Gerenciador de AddOns"
L[" 搜索"] = "Pesquisa"
L["重载插件"] = "Reiniciar UI"
L["配置"] = "Perfis"
L["新配置文件"] = "Novo perfil"
L["启用全部"] = "Ativar todos"
L["禁用全部"] = "Desativar todos"
L["配置文件名字"] = "Nome do perfil"
L["设置到"] = "Aplicar para.."
L["增加到"] = "Adc para.."
L["移除自"] = "Remover de.."
L["删除配置文件"] = "Excluir perfil.."
L["删除配置文件确认"] = "Você tem certeza que deseja excluir esse perfil? Segure shift e clique novamente se você tem certeza."
