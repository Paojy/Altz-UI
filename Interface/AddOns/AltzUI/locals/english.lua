...
L["大秘境信息"]	= "M+"
L["当前钥匙"] = "Current Key"
L["完成次数"] = "Completed Runs"
L["无大秘境记录"] = "No M+ runs have been completed this week."
L["大秘境记录"] = "Mythic+ Runs"
...
L["肖像"] = "Portrait"
L["单位框架治疗和吸收预估提示"] = "Show heal prediction bar and absorb bar on player/target/focus frame."
L["宽度提示"] = "The width for player, target and focus frame"
L["能量条"] = "Powerbar"
L["施法条"] = "Castbar"
L["独立施法条"] = "Independent cast bars"
L["依附施法条"] = "Cast bar attached to the unit frames"
L["平砍计时条"] = "Swing Timer"
...
L["额外法力条"] = "Additional mana bar"
L["法力条提示"] = "Display additional mana bar when the main resource type is not mana (such as energy, rage)"
L["醉拳条"] = "stagger bar"
...
L["预计治疗量"] = "heal prediction"
L["点击施法"] = "Click-Cast"
L["点击施法鼠标标记"] = "Click-Cast Cursor Texture"
L["生效标记"] = "Enable Texture"
L["不生效标记"] = "Disable Texture"
L["无标记"]	= "None"
...
L["根据血量变色"] = "Color according to hp perc"
