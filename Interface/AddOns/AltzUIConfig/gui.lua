...
Chattitle:SetPoint("TOPLEFT", 16, 3-1*30)
Chattitle:SetText(CHAT)

local enablechatbu = createcheckbutton(scrollFrame.Anchor, 2, L["Enable Chat"], "enablechat")
local channelreplacementbu = createcheckbutton(scrollFrame.Anchor, 3, L["Replace Channel Name"], "channelreplacement", L["Replace Channel Name2"])
local autoscrollbu = createcheckbutton(scrollFrame.Anchor, 4, L["Scroll Chat Frame"], "autoscroll", L["Scroll Chat Frame2"])

local aPlatetitle = scrollFrame.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
aPlatetitle:SetPoint("TOPLEFT", 16, 3-5*30)
aPlatetitle:SetText(UNIT_NAMEPLATES)

local enableplatebu = createcheckbutton(scrollFrame.Anchor, 6, L["Enable Plate"], "enableplate")
local autotoggleplatesbu = createcheckbutton(scrollFrame.Anchor, 7, L["Auto Toggle"], "autotoggleplates", L["Auto Toggle2"])
local threatplatesbu = createcheckbutton(scrollFrame.Anchor, 8, L["Threat Color"], "threatplates", L["Threat Color2"])
createDR(enableplatebu, autotoggleplatesbu, threatplatesbu)

local aTiptitle = scrollFrame.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
aTiptitle:SetPoint("TOPLEFT", 16, 3-9*30)
aTiptitle:SetText(USE_UBERTOOLTIPS)

local enabletipbu = createcheckbutton(scrollFrame.Anchor, 10, L["Enable Tip"], "enabletip")
local cursorbu = createcheckbutton(scrollFrame.Anchor, 11, L["Show at Mouse"], "cursor", L["Show at Mouse2"])
local hideRealmbu = createcheckbutton(scrollFrame.Anchor, 12, L["Hide Realm"], "hideRealm", L["Hide Realm2"])
local hideTitlesbu = createcheckbutton(scrollFrame.Anchor, 13, L["Hide Title"], "hideTitles", L["Hide Title2"])
local showspellIDbu = createcheckbutton(scrollFrame.Anchor, 14, L["Show SpellID"], "showspellID", L["Show SpellID2"])
local colorborderClassbu = createcheckbutton(scrollFrame.Anchor, 15, L["Class Color"], "colorborderClass", L["Class Color2"])
local combathidebu = createcheckbutton(scrollFrame.Anchor, 16, L["Hide in Combat"], "combathide", L["Hide in Combat2"])
...
aTweakstitle:SetPoint("TOPLEFT", 16, 3-17*30)
aTweakstitle:SetText(OTHER)

local autorepairbu = createcheckbutton(scrollFrame.Anchor, 18, L["autorepair"], "autorepair", L["autorepair2"])
local autorepair_guildbu = createcheckbutton(scrollFrame.Anchor, 19, L["autorepair_guild"], "autorepair_guild", L["autorepair_guild2"])
local autosellbu = createcheckbutton(scrollFrame.Anchor, 20, L["autosell"], "autosell", L["autosell2"])
local helmcloakbuttonsbu = createcheckbutton(scrollFrame.Anchor, 21, L["helmcloakbuttons"], "helmcloakbuttons", L["helmcloakbuttons2"])
local undressbuttonbu = createcheckbutton(scrollFrame.Anchor, 22, L["undressbutton"], "undressbutton", L["undressbutton2"])
local autoscreenshotbu = createcheckbutton(scrollFrame.Anchor, 23, L["Achievement Shot"], "autoscreenshot", L["Achievement Shot2"])
local alreadyknownbu = createcheckbutton(scrollFrame.Anchor, 24, L["Colorizes Known Items"], "alreadyknown", L["Colorizes Known Items2"])
local collectgarbagebu = createcheckbutton(scrollFrame.Anchor, 25, L["Collect Garbage"], "collectgarbage", L["Collect Garbage2"])
local acceptresbu = createcheckbutton(scrollFrame.Anchor, 26, L["Accept Resurrects"], "acceptres", L["Accept Resurrects2"])
local battlegroundresbu = createcheckbutton(scrollFrame.Anchor, 27, L["Releases Spirit in BG"], "battlegroundres", L["Releases Spirit in BG2"])
local hideerrorsbu = createcheckbutton(scrollFrame.Anchor, 28, L["Hide Errors"], "hideerrors", L["Hide Errors2"])
local acceptfriendlyinvitesbu = createcheckbutton(scrollFrame.Anchor, 29, L["Accept Invites"], "acceptfriendlyinvites", L["Accept Invites2"])
local autoquestsbu = createcheckbutton(scrollFrame.Anchor, 30, L["Auto Quests"], "autoquests", L["Auto Quests2"])
local combattextbu = createcheckbutton(scrollFrame.Anchor, 31, L["Combat Text"], "combattext", L["Combat Text2"])
local saysappedbu = createcheckbutton(scrollFrame.Anchor, 32, L["Say Sapped"], "saysapped", L["Say Sapped2"])
local camerabu = createcheckbutton(scrollFrame.Anchor, 33, L["camera"], "camera", L["camera2"])
local raidcdenablebu = createcheckbutton(scrollFrame.Anchor, 34, L["RaidCD"], "raidcdenable", L["RaidCD2"])

local raidcdwidthbox = createeditbox(scrollFrame.Anchor, 35, L["RaidCD Width"], "raidcdwidth")
local raidcdheightbox = createeditbox(scrollFrame.Anchor, 36, L["RaidCD Height"], "raidcdheight")
local raidcdfontsizebox = createeditbox(scrollFrame.Anchor, 37, L["RaidCD FontSize"], "raidcdfontsize")
...
bar12title:SetPoint("TOPLEFT", 16, 3-4*30)
bar12title:SetText(L["Bar1&2"])

local bar12sizebox = createeditbox(scrollFrame2.Anchor, 5, L["buttonsize"], "bar12size")
local bar12spacebox = createeditbox(scrollFrame2.Anchor, 6, L["buttonspace"], "bar12space")
local bar12mfadebu = createcheckbutton(scrollFrame2.Anchor, 7, L["mousefade"], "bar12mfade", L["mousefade2"])
local bar12efadebu = createcheckbutton(scrollFrame2.Anchor, 8, L["eventfade"], "bar12efade", L["eventfade2"])
local bar12fademinaplhaslider = createslider(scrollFrame2.Anchor, 9, L["fademinalpha"], "bar12fademinaplha", 0, 0.8, 0.05, L["fademinalpha2"])

local bar3title = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
bar3title:SetPoint("TOPLEFT", 16, 3-10*30)
bar3title:SetText(L["Bar3"])

local bar3uselayout322bu = createcheckbutton(scrollFrame2.Anchor, 11, L["Bar3 layout322"], "bar3uselayout322", L["Bar3 layout3222"])
local space1box = createeditbox(scrollFrame2.Anchor, 12, L["bar3space"], "space1", L["bar3space2"])
local bar3sizebox = createeditbox(scrollFrame2.Anchor, 13, L["buttonsize"], "bar3size")
local bar3spacebox = createeditbox(scrollFrame2.Anchor, 14, L["buttonspace"], "bar3space")
local bar3mfadebu = createcheckbutton(scrollFrame2.Anchor, 15, L["mousefade"], "bar3mfade", L["mousefade2"])
local bar3efadebu = createcheckbutton(scrollFrame2.Anchor, 16, L["eventfade"], "bar3efade", L["eventfade2"])
local bar3fademinaplhaslider = createslider(scrollFrame2.Anchor, 17, L["fademinalpha"], "bar3fademinaplha", 0, 0.8, 0.05, L["fademinalpha2"])

local bar45title = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
bar45title:SetPoint("TOPLEFT", 16, 3-18*30)
bar45title:SetText(L["Bar4&5"])

local bar45sizebox = createeditbox(scrollFrame2.Anchor, 19, L["buttonsize"], "bar45size")
local bar45spacebox = createeditbox(scrollFrame2.Anchor, 20, L["buttonspace"], "bar45space")
local bar45mfadebu = createcheckbutton(scrollFrame2.Anchor, 21, L["mousefade"], "bar45mfade", L["mousefade2"])
local bar45efadebu = createcheckbutton(scrollFrame2.Anchor, 22, L["eventfade"], "bar45efade", L["eventfade2"])
local bar45fademinaplhaslider = createslider(scrollFrame2.Anchor, 23, L["fademinalpha"], "bar45fademinaplha", 0, 0.8, 0.05, L["fademinalpha2"])

local petbartitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
petbartitle:SetPoint("TOPLEFT", 16, 3-24*30)
petbartitle:SetText(L["Petbar"])

local petbaruselayout5x2bu = createcheckbutton(scrollFrame2.Anchor, 25, L["petbaruselayout5x2"], "petbaruselayout5x2", L["petbaruselayout5x22"])
local petbarscaleslider = createslider(scrollFrame2.Anchor, 26, L["barscale"], "petbarscale", 0.5, 2.5, 0.1)
local petbuttonspacebox = createeditbox(scrollFrame2.Anchor, 27, L["buttonspace"], "petbuttonspace")
local petbarmfadebu = createcheckbutton(scrollFrame2.Anchor, 28, L["mousefade"], "petbarmfade", L["mousefade2"])
local petbarefadebu = createcheckbutton(scrollFrame2.Anchor, 29, L["eventfade"], "petbarefade", L["eventfade2"])
local petbarfademinaplhaslider = createslider(scrollFrame2.Anchor, 30, L["fademinalpha"], "petbarfademinaplha", 0, 0.8, 0.05, L["fademinalpha2"])

local stancebartitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
stancebartitle:SetPoint("TOPLEFT", 16, 3-31*30)
stancebartitle:SetText(L["Stancebar"])

local stancebarbuttonsziebox = createeditbox(scrollFrame2.Anchor, 32, L["buttonsize"], "stancebarbuttonszie")
local stancebarbuttonspacebox = createeditbox(scrollFrame2.Anchor, 33, L["buttonspace"], "stancebarbuttonspace")

local micromenutitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
micromenutitle:SetPoint("TOPLEFT", 16, 3-34*30)
micromenutitle:SetText(L["MicroMenu"])

local micromenuscaleslider = createslider(scrollFrame2.Anchor, 35, L["barscale"], "micromenuscale", 0.5, 2.5, 0.1)
local micromenufadebu = createcheckbutton(scrollFrame2.Anchor, 36, L["mousefade"], "micromenufade", L["mousefade2"])
local micromenuminalphaslider = createslider(scrollFrame2.Anchor, 37, L["fademinalpha"], "micromenuminalpha", 0, 0.8, 0.05, L["fademinalpha2"])

local leave_vehicletitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
leave_vehicletitle:SetPoint("TOPLEFT", 16, 3-38*30)
leave_vehicletitle:SetText(L["leave_vehicle"])

local leave_vehiclebuttonsizebox = createeditbox(scrollFrame2.Anchor, 39, L["buttonsize"], "leave_vehiclebuttonsize")

local extrabartitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLeftYellow")
extrabartitle:SetPoint("TOPLEFT", 16, 3-40*30)
extrabartitle:SetText(L["extrabarbutton"])

local extrabarbuttonsizebox = createeditbox(scrollFrame2.Anchor, 41, L["buttonsize"], "extrabarbuttonsize")

local BuffFrametitle = scrollFrame2.Anchor:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
BuffFrametitle:SetPoint("TOPLEFT", 16, 3-42*30)
BuffFrametitle:SetText(BUFFOPTIONS_LABEL)

local buffrowspacebox = createeditbox(scrollFrame2.Anchor, 43, L["buffrowspace"], "buffrowspace")
local buffcolspacebox = createeditbox(scrollFrame2.Anchor, 44, L["buffcolspace"], "buffcolspace")
local buffsPerRowbox = createeditbox(scrollFrame2.Anchor, 45, L["buffsPerRow"], "buffsPerRow")
local buffdebuffgapbox = createeditbox(scrollFrame2.Anchor, 46, L["buffdebuffgap"], "buffdebuffgap")
--====================================================--
--[[               -- Reset UI --                   ]]--
--====================================================--
