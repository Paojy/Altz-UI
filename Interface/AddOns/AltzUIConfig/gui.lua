...
local autotoggleplatesbu = createcheckbutton(scrollFrame.Anchor, 9, L["Auto Toggle"], "autotoggleplates", L["Auto Toggle2"])
local threatplatesbu = createcheckbutton(scrollFrame.Anchor, 10, L["Threat Color"], "threatplates", L["Threat Color2"])
...
aTiptitle:SetPoint("TOPLEFT", 16, 3-11*30)
aTiptitle:SetText(USE_UBERTOOLTIPS)

local enabletipbu = createcheckbutton(scrollFrame.Anchor, 12, L["Enable Tip"], "enabletip")
local cursorbu = createcheckbutton(scrollFrame.Anchor, 13, L["Show at Mouse"], "cursor", L["Show at Mouse2"])
local hideRealmbu = createcheckbutton(scrollFrame.Anchor, 14, L["Hide Realm"], "hideRealm", L["Hide Realm2"])
local hideTitlesbu = createcheckbutton(scrollFrame.Anchor, 15, L["Hide Title"], "hideTitles", L["Hide Title2"])
local showspellIDbu = createcheckbutton(scrollFrame.Anchor, 16, L["Show SpellID"], "showspellID", L["Show SpellID2"])
local colorborderClassbu = createcheckbutton(scrollFrame.Anchor, 17, L["Class Color"], "colorborderClass", L["Class Color2"])
local combathidebu = createcheckbutton(scrollFrame.Anchor, 18, L["Hide in Combat"], "combathide", L["Hide in Combat2"])
...
aTweakstitle:SetPoint("TOPLEFT", 16, 3-19*30)
aTweakstitle:SetText(OTHER)

local autorepairbu = createcheckbutton(scrollFrame.Anchor, 20, L["autorepair"], "autorepair", L["autorepair2"])
local autorepair_guildbu = createcheckbutton(scrollFrame.Anchor, 21, L["autorepair_guild"], "autorepair_guild", L["autorepair_guild2"])
local autosellbu = createcheckbutton(scrollFrame.Anchor, 22, L["autosell"], "autosell", L["autosell2"])
local helmcloakbuttonsbu = createcheckbutton(scrollFrame.Anchor, 23, L["helmcloakbuttons"], "helmcloakbuttons", L["helmcloakbuttons2"])
local undressbuttonbu = createcheckbutton(scrollFrame.Anchor, 24, L["undressbutton"], "undressbutton", L["undressbutton2"])
local autoscreenshotbu = createcheckbutton(scrollFrame.Anchor, 25, L["Achievement Shot"], "autoscreenshot", L["Achievement Shot2"])
local alreadyknownbu = createcheckbutton(scrollFrame.Anchor, 26, L["Colorizes Known Items"], "alreadyknown", L["Colorizes Known Items2"])
local collectgarbagebu = createcheckbutton(scrollFrame.Anchor, 27, L["Collect Garbage"], "collectgarbage", L["Collect Garbage2"])
local acceptresbu = createcheckbutton(scrollFrame.Anchor, 28, L["Accept Resurrects"], "acceptres", L["Accept Resurrects2"])
local battlegroundresbu = createcheckbutton(scrollFrame.Anchor, 29, L["Releases Spirit in BG"], "battlegroundres", L["Releases Spirit in BG2"])
local hideerrorsbu = createcheckbutton(scrollFrame.Anchor, 30, L["Hide Errors"], "hideerrors", L["Hide Errors2"])
local acceptfriendlyinvitesbu = createcheckbutton(scrollFrame.Anchor, 31, L["Accept Invites"], "acceptfriendlyinvites", L["Accept Invites2"])
local autoquestsbu = createcheckbutton(scrollFrame.Anchor, 32, L["Auto Quests"], "autoquests", L["Auto Quests2"])
local combattextbu = createcheckbutton(scrollFrame.Anchor, 33, L["Combat Text"], "combattext", L["Combat Text2"])
local saysappedbu = createcheckbutton(scrollFrame.Anchor, 34, L["Say Sapped"], "saysapped", L["Say Sapped2"])
local camerabu = createcheckbutton(scrollFrame.Anchor, 35, L["camera"], "camera", L["camera2"])
local raidcdenablebu = createcheckbutton(scrollFrame.Anchor, 36, L["RaidCD"], "raidcdenable", L["RaidCD2"])

local raidcdwidthbox = createeditbox(scrollFrame.Anchor, 37, L["RaidCD Width"], "raidcdwidth")
local raidcdheightbox = createeditbox(scrollFrame.Anchor, 38, L["RaidCD Height"], "raidcdheight")
local raidcdfontsizebox = createeditbox(scrollFrame.Anchor, 39, L["RaidCD FontSize"], "raidcdfontsize")
