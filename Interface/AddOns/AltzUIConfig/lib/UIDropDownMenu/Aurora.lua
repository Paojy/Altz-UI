...
hooksecurefunc("L_ToggleDropDownMenu", function(level, _, dropDownFrame, anchorName)
	...
	for j = 1, L_UIDROPDOWNMENU_MAXBUTTONS do
		local bu = _G["L_DropDownList"..level.."Button"..j]
		local _, _, _, x = bu:GetPoint()
		if bu:IsShown() and x then
			local hl = _G["L_DropDownList"..level.."Button"..j.."Highlight"]
			local check = _G["L_DropDownList"..level.."Button"..j.."Check"]
			...
			if not bu.bg then
				...
				_G["L_DropDownList"..level.."Button"..j.."UnCheck"]:SetTexture("")

				local arrow = _G["L_DropDownList"..level.."Button"..j.."ExpandArrow"]
...
hooksecurefunc("L_UIDropDownMenu_SetIconImage", function(icon, texture)
