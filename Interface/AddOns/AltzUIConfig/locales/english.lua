...
L["自动显示/隐藏提示"] = "Toggle Nameplates when entering and leaving combat."
...
L["过滤战斗信息提示"] = "Hide most of AoE healing and damage text in order to avoid spam."
...
L["自动接受排本邀请"] = "Automatically Accept LFG Queue"
L["自动接受排本邀请提示"] = "Automatically accepts Dungeon, LFR and BG queues after 35s"
