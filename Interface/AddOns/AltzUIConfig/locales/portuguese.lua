...
L["正向"] = "Crescente"
L["反向"] = "Decrescente"
L["显示数值"] = "Mostrar valor de %s"
L["显示时间"] = "Mostrar duração de %s."
...
L["过滤阈值提示"] = "Precisa conter pelo menos o número de palavras para esconder a mensagem."
...
L["按职业染色提示"] = "Ativado: vida colorizada baseado na clase, poder colorizado baseaso no tipo.\nDesativado: vida colorizada baseasdo na porcentagem, poder colorizado baseasdo na classe."
L["名字职业着色"] = "Nome colorizado pela classe"
L["名字职业着色提示"] = "Ativado: Colorizado pela classe.\nDesativado: Branco."
L["肖像"] = "Retrato"
...
L["自动显示/隐藏"] = "Auto alternância"
L["自动显示/隐藏提示"] = "Alternar placas de nomes quando entrar e sair de combate."
...
L["不显示资源"] = "Não mostrar isso"

-- 鼠标提示
L["跟随光标"] = "Mostrar no mouse"
L["跟随光标提示"] = "Mostra dicas de interface onde o mouse estiver."
...
L["过滤战斗信息提示"] = "Esconder alguns textos de cura/dano para minimizar o 'spam'."
...
L["整理隐藏的小地图图标"] = "Coletar botões escondidos do minimapa"
...
L["自动接受排本邀请"] = "Automáticamente aceitar fila"
L["自动接受排本邀请提示"] = "Automáticamente aceita fila do Loc. de grupos depois de 35s"
L["在战斗中隐藏小地图和聊天框"] = "Esconder minimapa e bate-papo em combate"
