...
tinsert(C.defaultThemes, function()
	...
	ReskinFont(NumberFont_Outline_Med) -- 价格
	ReskinFont(NumberFont_Outline_Large)
	ReskinFont(NumberFont_Outline_Huge)
	ReskinFont(NumberFont_Shadow_Med)
	ReskinFont(NumberFont_Shadow_Small)
	ReskinFont(Number11Font)
	ReskinFont(Number12Font, 12)
	ReskinFont(Number12Font_o1, 12)
	ReskinFont(Number12FontOutline, 12)
	ReskinFont(Number13Font)
	...
	ReskinFont(QuestFont_Outline_Huge)
	ReskinFont(QuestFont_Huge)
	ReskinFont(QuestFont_Shadow_Super_Huge)
	ReskinFont(QuestFont_Super_Huge_Outline)
	...
	ReskinFont(SystemFont_Huge1_Outline)
	...
	ReskinFont(SystemFont_Shadow_Med1, 12) -- 卖价
	...
	ReskinFont(SystemFont_Shadow_Small,12) -- 品质
	...
	ReskinFont(Game11Font_Shadow)
	ReskinFont(Game11Font_o1)
	ReskinFont(Game12Font)
	ReskinFont(Game12Font_o1)
	ReskinFont(Game13Font)
	ReskinFont(Game13Font_o1)
	ReskinFont(Game13FontShadow)
	ReskinFont(Game15Font)
	ReskinFont(Game15Font_o1)
	...
	ReskinFont(Fancy36Font)
	ReskinFont(Fancy40Font)
	...
	ReskinFont(OrderHallTalentRowFont)
