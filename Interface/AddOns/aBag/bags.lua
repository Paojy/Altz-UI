...
function SetUp(framen, ...)
	...
	local frame_bags_toggle_text = createtext(frame_bags_toggle, 12, "OUTLINE", true)
	...
	local bagsortt = createtext(bagsort, 12, "OUTLINE", true)
	bagsortt:SetText("S")
	...
	local closet = createtext(close, 12, "OUTLINE", true)
	closet:SetText("X")
