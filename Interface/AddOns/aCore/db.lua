...
local function LoadaModVariables()
	aCoreCDB = {}
...
ns.LoadaModVariables = LoadaModVariables

local function ResetDefault()
	if aCoreCDB.setaMod then
		aCoreCDB.notmeet = true
		return
	end
end
ns.ResetDefault = ResetDefault

local function ResetAllAddonSettings()
