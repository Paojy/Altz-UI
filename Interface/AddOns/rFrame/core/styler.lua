local textures = {
    ...
    normal            = "Interface\\AddOns\\rFrame\\media\\gloss",
    flash             = "Interface\\AddOns\\rFrame\\media\\flash",
    hover             = "Interface\\AddOns\\rFrame\\media\\hover",
    pushed            = "Interface\\AddOns\\rFrame\\media\\pushed",
    checked           = "Interface\\AddOns\\rFrame\\media\\checked",
    equipped          = "Interface\\AddOns\\rFrame\\media\\gloss_grey",
    outer_shadow      = "Interface\\AddOns\\rFrame\\media\\outer_shadow",
  }
